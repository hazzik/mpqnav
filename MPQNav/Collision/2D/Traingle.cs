...
namespace MPQNav.Collision._2D
{
    internal class Triangle
    {
        ...
        public float getSlop3X()
        {
            ...
            {
                p1 = point2.X < point3.X ? point2 : point3;
            }
            // p2
            if (point1.X > point2.X)
            {
                p2 = point1.X > point3.X ? point1 : point3;
            }
            else
            {
                p2 = point2.X > point3.X ? point2 : point3;
            }
        ...
        public float getSlopeZ()
        {
            ...
            {
                p1 = point1.Y < point3.Y ? point1 : point3;
            }
            else
            {
                p1 = point2.Y < point3.Y ? point2 : point3;
            }
            // p2
            if (point1.Y > point2.Y)
            {
                p2 = point1.Y > point3.Y ? point1 : point3;
            }
            else
            {
                p2 = point2.Y > point3.Y ? point2 : point3;
            }
                                                ...
                                                out float t, out float u, out float v)
        {
            ...
            v = Vector3.Dot(ray_direction, qvec)*invDet;
