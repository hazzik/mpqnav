...
namespace XnaConsole {
	...
	internal class KeyboardHelper {
		public static KeyBinding[] ItalianBindings = new KeyBinding[] {
		...
		public static KeyBinding[] SwedishBindings = new KeyBinding[] {
			new KeyBinding(Keys.OemPipe, "\\", "|", "", ""),
			new KeyBinding(Keys.OemBackslash, "\\", "|", "", ""),
			new KeyBinding(Keys.OemOpenBrackets, "[", "{", "", ""),
		...
		public static KeyBinding[] AmericanBindings = new KeyBinding[] {
			new KeyBinding(Keys.OemPipe, "\\", "|", "", ""),
			new KeyBinding(Keys.OemBackslash, "\\", "|", "", ""),
			new KeyBinding(Keys.OemOpenBrackets, "[", "{", "", ""),
			new KeyBinding(Keys.OemCloseBrackets, "]", "}", "", ""),
